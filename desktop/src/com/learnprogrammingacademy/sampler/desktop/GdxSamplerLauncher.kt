...
import com.learnprogrammingacademy.sampler.common.SampleInfo
...
class GdxSamplerLauncher : JFrame() {
    ...
    private fun createControlPanel() {
        ...
        // add double click to launch samples
    ...
    private fun launchSelectedSample() {
        ...
        if(sampleName.isNullOrBlank()) {
            println("samples name is null or blank cant launch")
            return
        }
    ...
    private fun launchSample(name: String?) {
        ...
        // cleanup before running new samples
        lwjglAWTCanvas?.stop()
